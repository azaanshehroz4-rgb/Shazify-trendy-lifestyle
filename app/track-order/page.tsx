...
export default function TrackOrderPage() {
  ...
  const handleTrackOrder = async () => {
    ...
    if (!email.trim()) {
      alert("Please enter the email used for your order.");
      return;
    }
    ...
    <div className="max-w-4xl mx-auto p-10">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="text-gray-600 mb-6">
          Enter your Order ID and the email address used
        ...
        <input
          ...
          className="w-full border p-4 rounded-xl mb-4 focus:outline-none focus:ring-2 focus:ring-pink-500"
        />
